import{s as S,O as L,A as G,T as y,a as b,c as k,i as p,d as m,f as d,g as h,x as M,j as f,z as B,l as D,h as V,m as j,y as C,X as T,G as z}from"../chunks/scheduler.2199cf1f.js";import{S as O,i as X,b as _,d as v,m as g,a as $,t as w,e as x}from"../chunks/index.ccf04077.js";import{g as F,a as R}from"../chunks/spread.8a54911c.js";import{M as J,p as K,C as N,a as H,r as E}from"../chunks/ClassTable.122104ee.js";function Q(c){let e,r='<ul><li><span class="hover:underline cursor-pointer inline-flex gap-2 items-center">Home</span></li> <li><span class="hover:underline cursor-pointer inline-flex gap-2 items-center">Documents</span></li> <li>Add Document</li></ul>';return{c(){e=d("div"),e.innerHTML=r,this.h()},l(t){e=h(t,"DIV",{class:!0,"data-svelte-h":!0}),M(e)!=="svelte-19d4qk"&&(e.innerHTML=r),this.h()},h(){f(e,"class","text-sm breadcrumbs")},m(t,a){p(t,e,a)},p:B,d(t){t&&m(e)}}}function U(c){let e,r=`<div class="text-sm $$breadcrumbs">
  <ul>
    <li><a>Home</a></li> 
    <li><a>Documents</a></li> 
    <li>Add Document</li>
