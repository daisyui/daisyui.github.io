...
</div>`),b(t,(n,i)=>u(n,i),()=>({to:l()})),a(d,t)}}});var S=e(e($,!0));p(S,{title:"Table with an active row",children:(d,o)=>{var t=N();a(d,t)},$$slots:{default:!0,html:(d,o)=>{var t=J(),h=c(t);h.nodeValue=s(`<div class="overflow-x-auto">
  <table class="$$table">
    <!-- head -->
    <thead>
      <tr>
...
</div>`),b(t,(n,i)=>u(n,i),()=>({to:l()})),a(d,t)}}});var C=e(e(S,!0));p(C,{title:"Table with a row that highlights on hover",children:(d,o)=>{var t=q();a(d,t)},$$slots:{default:!0,html:(d,o)=>{var t=Z(),h=c(t);h.nodeValue=s(`<div class="overflow-x-auto">
  <table class="$$table">
    <!-- head -->
    <thead>
      <tr>
...
</div>`),b(t,(n,i)=>u(n,i),()=>({to:l()})),a(d,t)}}});var w=e(e(C,!0));p(w,{title:"Zebra",children:(d,o)=>{var t=O();a(d,t)},$$slots:{default:!0,html:(d,o)=>{var t=Q(),h=c(t);h.nodeValue=s(`<div class="overflow-x-auto">
...
</div>`),b(t,(n,i)=>u(n,i),()=>({to:l()})),a(d,t)}}});var f=e(e(w,!0));p(f,{title:"Table with visual elements",children:(d,o)=>{var t=E();a(d,t)},$$slots:{default:!0,html:(d,o)=>{var t=U(),h=c(t);h.nodeValue=s(`<div class="overflow-x-auto">
  <table class="$$table">
    <!-- head -->
    <thead>
      <tr>
...
</div>`),b(t,(n,i)=>u(n,i),()=>({to:l()})),a(d,t)}}});var k=e(e(f,!0));p(k,{title:"Table xs",children:(d,o)=>{var t=Y();a(d,t)},$$slots:{default:!0,html:(d,o)=>{var t=j(),h=c(t);h.nodeValue=s(`<div class="overflow-x-auto">
...
</div>`),b(t,(n,i)=>u(n,i),()=>({to:l()})),a(d,t)}}});var T=e(e(k,!0));p(T,{title:"Table with pinned-rows",children:(d,o)=>{var t=X();a(d,t)},$$slots:{default:!0,html:(d,o)=>{var t=tt(),h=c(t);h.nodeValue=s(`<div class="overflow-x-auto h-96">
...
</div>`),b(t,(n,i)=>u(n,i),()=>({to:l()})),a(d,t)}}});var B=e(e(T,!0));p(B,{title:"Table with pinned-rows and pinned-cols",children:(d,o)=>{var t=dt();a(d,t)},$$slots:{default:!0,html:(d,o)=>{var t=at(),h=c(t);h.nodeValue=s(`<div class="overflow-x-auto">
...
</div>`),b(t,(n,i)=>u(n,i),()=>({to:l()})),a(d,t)}}}),a(L,y)},$$slots:{default:!0}})),a(P,v)}export{pt as component};
