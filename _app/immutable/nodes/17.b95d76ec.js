import{s as q,N as L,A as N,S as y,a as b,c as k,i as p,d as m,f as d,g as h,x as M,j as f,z as D,l as B,h as V,m as j,y as C,W as z,D as T}from"../chunks/scheduler.bdb05a6c.js";import{S as W,i as F,b as _,d as v,m as g,a as $,t as w,e as x}from"../chunks/index.cfde95cb.js";import{g as G,a as R}from"../chunks/spread.8a54911c.js";import{M as J,p as K,C as O,a as H,r as E}from"../chunks/ClassTable.29f1b961.js";function Q(c){let e,r='<ul><li><span class="hover:underline cursor-pointer inline-flex gap-2 items-center">Home</span></li> <li><span class="hover:underline cursor-pointer inline-flex gap-2 items-center">Documents</span></li> <li>Add Document</li></ul>';return{c(){e=d("div"),e.innerHTML=r,this.h()},l(t){e=h(t,"DIV",{class:!0,"data-svelte-h":!0}),M(e)!=="svelte-19d4qk"&&(e.innerHTML=r),this.h()},h(){f(e,"class","text-sm breadcrumbs")},m(t,a){p(t,e,a)},p:D,d(t){t&&m(e)}}}function U(c){let e,r=`<div class="text-sm $$breadcrumbs">
  <ul>
    <li><a>Home</a></li> 
    <li><a>Documents</a></li> 
    <li>Add Document</li>
...
</div>`,t,a,s,i;return{c(){e=d("pre"),t=B(r),this.h()},l(l){e=h(l,"PRE",{slot:!0});var o=V(e);t=j(o,r),o.forEach(m),this.h()},h(){f(e,"slot","html")},m(l,o){p(l,e,o),C(e,t),s||(i=z(a=E.call(null,e,{to:c[0]})),s=!0)},p(l,o){a&&T(a.update)&&o&1&&a.update.call(null,{to:l[0]})},d(l){l&&m(e),s=!1,i()}}}function te(c){let e,r,t,a,s,i,l,o;return e=new O({props:{data:[{type:"component",class:"breadcrumbs",desc:"Container element"}]}}),t=new H({props:{title:"Breadcrumbs",$$slots:{html:[U],default:[Q]},$$scope:{ctx:c}}}),s=new H({props:{title:"Breadcrumbs with icons",$$slots:{html:[Y],default:[X]},$$scope:{ctx:c}}}),l=new H({props:{title:"Breadcrumbs with max-width",desc:"If you set max-width or the list gets larger than the container it will scroll",$$slots:{html:[ee],default:[Z]},$$scope:{ctx:c}}}),{c(){_(e.$$.fragment),r=b(),_(t.$$.fragment),a=b(),_(s.$$.fragment),i=b(),_(l.$$.fragment)},l(n){v(e.$$.fragment,n),r=k(n),v(t.$$.fragment,n),a=k(n),v(s.$$.fragment,n),i=k(n),v(l.$$.fragment,n)},m(n,u){g(e,n,u),p(n,r,u),g(t,n,u),p(n,a,u),g(s,n,u),p(n,i,u),g(l,n,u),o=!0},p(n,u){const A={};u&5&&(A.$$scope={dirty:u,ctx:n}),t.$set(A);const I={};u&5&&(I.$$scope={dirty:u,ctx:n}),s.$set(I);const P={};u&5&&(P.$$scope={dirty:u,ctx:n}),l.$set(P)},i(n){o||($(e.$$.fragment,n),$(t.$$.fragment,n),$(s.$$.fragment,n),$(l.$$.fragment,n),o=!0)},o(n){w(e.$$.fragment,n),w(t.$$.fragment,n),w(s.$$.fragment,n),w(l.$$.fragment,n),o=!1},d(n){n&&(m(r),m(a),m(i)),x(e,n),x(t,n),x(s,n),x(l,n)}}}function se(c){let e,r;const t=[c[1],S];let a={$$slots:{default:[te]},$$scope:{ctx:c}};for(let s=0;s<t.length;s+=1)a=L(a,t[s]);return e=new J({props:a}),{c(){_(e.$$.fragment)},l(s){v(e.$$.fragment,s)},m(s,i){g(e,s,i),r=!0},p(s,[i]){const l=i&2?G(t,[i&2&&R(s[1]),i&0&&R(S)]):{};i&5&&(l.$$scope={dirty:i,ctx:s}),e.$set(l)},i(s){r||($(e.$$.fragment,s),r=!0)},o(s){w(e.$$.fragment,s),r=!1},d(s){x(e,s)}}}const S={title:"Breadcrumbs",desc:"Breadcrumbs helps users to navigate through the website.",published:!0,layout:"components"};function le(c,e,r){let t;return N(c,K,a=>r(0,t=a)),c.$$set=a=>{r(1,e=L(L({},e),y(a)))},e=y(e),[t,e]}class ie extends W{constructor(e){super(),F(this,e,le,se,q,{})}}export{ie as component};
