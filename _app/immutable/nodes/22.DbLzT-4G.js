...
</div>`),g(s,(o,d)=>n(o,d),()=>({to:m()})),a(i,s)}}});var w=l(l($,!0));u(w,{title:"Snap to center",children:(i,e)=>{var s=I();a(i,s)},$$slots:{html:(i,e)=>{var s=J(),c=p(s);c.nodeValue=r(`<div class="$$carousel $$carousel-center rounded-box">
  <div class="$$carousel-item">
...
</div>`),g(s,(o,d)=>n(o,d),()=>({to:m()})),a(i,s)}}});var y=l(l(w,!0));u(y,{title:"Snap to end",children:(i,e)=>{var s=K();a(i,s)},$$slots:{html:(i,e)=>{var s=N(),c=p(s);c.nodeValue=r(`<div class="$$carousel $$carousel-end rounded-box">
  <div class="$$carousel-item">
...
</div>`),g(s,(o,d)=>n(o,d),()=>({to:m()})),a(i,s)}}});var S=l(l(y,!0));u(S,{title:"Carousel with full width items",children:(i,e)=>{var s=O();a(i,s)},$$slots:{html:(i,e)=>{var s=Q(),c=p(s);c.nodeValue=r(`<div class="w-64 $$carousel rounded-box">
...
</div>`),g(s,(o,d)=>n(o,d),()=>({to:m()})),a(i,s)}}});var k=l(l(S,!0));u(k,{title:"Vertical carousel",children:(i,e)=>{var s=R();a(i,s)},$$slots:{html:(i,e)=>{var s=W(),c=p(s);c.nodeValue=r(`<div class="h-96 $$carousel $$carousel-vertical rounded-box">
...
</div>`),g(s,(o,d)=>n(o,d),()=>({to:m()})),a(i,s)}}});var j=l(l(k,!0));u(j,{title:"Carousel with half width items",children:(i,e)=>{var s=Y();a(i,s)},$$slots:{html:(i,e)=>{var s=Z(),c=p(s);c.nodeValue=r(`<div class="$$carousel rounded-box w-96">
...
</div>`),g(s,(o,d)=>n(o,d),()=>({to:m()})),a(i,s)}}});var C=l(l(j,!0));u(C,{title:"Full-bleed carousel",children:(i,e)=>{var s=ss();a(i,s)},$$slots:{html:(i,e)=>{var s=is(),c=p(s);c.nodeValue=r(`<div class="$$carousel $$carousel-center max-w-md p-4 space-x-4 bg-neutral rounded-box">
  <div class="$$carousel-item">
...
</div>`),g(s,(o,d)=>n(o,d),()=>({to:m()})),a(i,s)}}});var _=l(l(C,!0));u(_,{title:"Carousel with indicator buttons",desc:"This slider works with anchor links so the browser will snap vertically to the image when you click buttons.",children:(i,e)=>{var s=as();a(i,s)},$$slots:{html:(i,e)=>{var s=ts(),c=p(s);c.nodeValue=r(`<div class="$$carousel w-full">
...
</div>`),g(s,(o,d)=>n(o,d),()=>({to:m()})),a(i,s)}}});var F=l(l(_,!0));u(F,{title:"Carousel with next/prev buttons",desc:"This slider works with anchor links so the browser will snap vertically to the image when you click buttons.",children:(i,e)=>{var s=ls();a(i,s)},$$slots:{html:(i,e)=>{var s=es(),c=p(s);c.nodeValue=r(`<div class="$$carousel w-full">
...
</div>`),g(s,(o,d)=>n(o,d),()=>({to:m()})),a(i,s)}}}),a(D,f)}})),a(T,h)}export{hs as component};
