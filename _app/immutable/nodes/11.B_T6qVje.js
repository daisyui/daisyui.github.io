...
</div>`),v(e,(n,d)=>h(n,d),()=>({to:p()})),s(l,e)}}});var _=o(o(k,!0));m(_,{title:"Accordion with arrow icon",children:(l,i)=>{var e=N();s(l,e)},$$slots:{html:(l,i)=>{var e=O(),c=a(e);c.nodeValue=r(`<div class="$$collapse $$collapse-arrow bg-base-200">
...
</div>`),v(e,(n,d)=>h(n,d),()=>({to:p()})),s(l,e)}}});var g=o(o(_,!0));m(g,{title:"Accordion with plus/minus icon",children:(l,i)=>{var e=Q();s(l,e)},$$slots:{html:(l,i)=>{var e=R(),c=a(e);c.nodeValue=r(`<div class="$$collapse $$collapse-plus bg-base-200">
...
</div>`),v(e,(n,d)=>h(n,d),()=>({to:p()})),s(l,e)}}});var L=o(o(g,!0));m(L,{title:"Using Accordion and Join together",desc:"to join the items together and handle border radius automatically",children:(l,i)=>{var e=W();s(l,e)},$$slots:{html:(l,i)=>{var e=Z(),c=a(e);c.nodeValue=r(`<div class="$$join $$join-vertical w-full">
...
</div>`),v(e,(n,d)=>h(n,d),()=>({to:p()})),s(l,e)}}}),s(T,b)}})),s(j,u)}export{re as component};
