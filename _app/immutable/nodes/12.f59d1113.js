import{s as it,O as F,A as nt,T as at,a as b,c as w,i as c,d,f as $,g,x as T,j as h,z as L,l as D,h as I,m as V,y as E,X as P,D as R}from"../chunks/scheduler.1c9dfc36.js";import{S as ot,i as rt,b as x,d as C,m as S,a as j,t as M,e as A}from"../chunks/index.e0dd2bc6.js";import{g as dt,a as st}from"../chunks/spread.8a54911c.js";import{M as ct,p as vt,C as pt,a as H,r as q}from"../chunks/ClassTable.1bebeaac.js";function ut(v){let t,r='<div class="w-24 rounded bg-base-300"><img src="/images/stock/photo-1534528741775-53994a69daeb.jpg" alt="Tailwind-CSS-Avatar-component"/></div>';return{c(){t=$("div"),t.innerHTML=r,this.h()},l(s){t=g(s,"DIV",{class:!0,"data-svelte-h":!0}),T(t)!=="svelte-tk0hy4"&&(t.innerHTML=r),this.h()},h(){h(t,"class","avatar")},m(s,a){c(s,t,a)},p:L,d(s){s&&d(t)}}}function mt(v){let t,r=`<div class="$$avatar">
...
</div>`,s,a,i,o;return{c(){t=$("pre"),s=D(r),this.h()},l(e){t=g(e,"PRE",{slot:!0});var n=I(t);s=V(n,r),n.forEach(d),this.h()},h(){h(t,"slot","html")},m(e,n){c(e,t,n),E(t,s),i||(o=P(a=q.call(null,t,{to:v[0]})),i=!0)},p(e,n){a&&R(a.update)&&n&1&&a.update.call(null,{to:e[0]})},d(e){e&&d(t),i=!1,o()}}}function Lt(v){let t,r,s,a,i,o,e,n,m,f,k,p,_,y,z,J,O,K,X,B;return t=new pt({props:{data:[{type:"component",class:"avatar",desc:"Container element"},{type:"component",class:"avatar-group",desc:"Container for grouping multiple avatars"},{type:"modifier",class:"online",desc:"shows a green dot as online indicator"},{type:"modifier",class:"offline",desc:"shows a gray dot as offline indicator"},{type:"modifier",class:"placeholder",desc:"to show some letters as avatar placeholder"}]}}),s=new H({props:{title:"Avatar",$$slots:{html:[mt],default:[ut]},$$scope:{ctx:v}}}),i=new H({props:{title:"Avatar in custom sizes",$$slots:{html:[$t],default:[ft]},$$scope:{ctx:v}}}),e=new H({props:{title:"Avatar rounded",$$slots:{html:[ht],default:[gt]},$$scope:{ctx:v}}}),m=new H({props:{title:"Avatar with mask",$$slots:{html:[bt],default:[_t]},$$scope:{ctx:v}}}),k=new H({props:{title:"Avatar group",$$slots:{html:[Tt],default:[wt]},$$scope:{ctx:v}}}),_=new H({props:{title:"Avatar group with counter",$$slots:{html:[xt],default:[kt]},$$scope:{ctx:v}}}),z=new H({props:{title:"Avatar with ring",$$slots:{html:[St],default:[Ct]},$$scope:{ctx:v}}}),O=new H({props:{title:"Avatar with presence indicator",$$slots:{html:[Mt],default:[jt]},$$scope:{ctx:v}}}),X=new H({props:{title:"Avatar placeholder",$$slots:{html:[Ht],default:[At]},$$scope:{ctx:v}}}),{c(){x(t.$$.fragment),r=b(),x(s.$$.fragment),a=b(),x(i.$$.fragment),o=b(),x(e.$$.fragment),n=b(),x(m.$$.fragment),f=b(),x(k.$$.fragment),p=b(),x(_.$$.fragment),y=b(),x(z.$$.fragment),J=b(),x(O.$$.fragment),K=b(),x(X.$$.fragment)},l(l){C(t.$$.fragment,l),r=w(l),C(s.$$.fragment,l),a=w(l),C(i.$$.fragment,l),o=w(l),C(e.$$.fragment,l),n=w(l),C(m.$$.fragment,l),f=w(l),C(k.$$.fragment,l),p=w(l),C(_.$$.fragment,l),y=w(l),C(z.$$.fragment,l),J=w(l),C(O.$$.fragment,l),K=w(l),C(X.$$.fragment,l)},m(l,u){S(t,l,u),c(l,r,u),S(s,l,u),c(l,a,u),S(i,l,u),c(l,o,u),S(e,l,u),c(l,n,u),S(m,l,u),c(l,f,u),S(k,l,u),c(l,p,u),S(_,l,u),c(l,y,u),S(z,l,u),c(l,J,u),S(O,l,u),c(l,K,u),S(X,l,u),B=!0},p(l,u){const G={};u&5&&(G.$$scope={dirty:u,ctx:l}),s.$set(G);const N={};u&5&&(N.$$scope={dirty:u,ctx:l}),i.$set(N);const Q={};u&5&&(Q.$$scope={dirty:u,ctx:l}),e.$set(Q);const U={};u&5&&(U.$$scope={dirty:u,ctx:l}),m.$set(U);const W={};u&5&&(W.$$scope={dirty:u,ctx:l}),k.$set(W);const Y={};u&5&&(Y.$$scope={dirty:u,ctx:l}),_.$set(Y);const Z={};u&5&&(Z.$$scope={dirty:u,ctx:l}),z.$set(Z);const tt={};u&5&&(tt.$$scope={dirty:u,ctx:l}),O.$set(tt);const et={};u&5&&(et.$$scope={dirty:u,ctx:l}),X.$set(et)},i(l){B||(j(t.$$.fragment,l),j(s.$$.fragment,l),j(i.$$.fragment,l),j(e.$$.fragment,l),j(m.$$.fragment,l),j(k.$$.fragment,l),j(_.$$.fragment,l),j(z.$$.fragment,l),j(O.$$.fragment,l),j(X.$$.fragment,l),B=!0)},o(l){M(t.$$.fragment,l),M(s.$$.fragment,l),M(i.$$.fragment,l),M(e.$$.fragment,l),M(m.$$.fragment,l),M(k.$$.fragment,l),M(_.$$.fragment,l),M(z.$$.fragment,l),M(O.$$.fragment,l),M(X.$$.fragment,l),B=!1},d(l){l&&(d(r),d(a),d(o),d(n),d(f),d(p),d(y),d(J),d(K)),A(t,l),A(s,l),A(i,l),A(e,l),A(m,l),A(k,l),A(_,l),A(z,l),A(O,l),A(X,l)}}}function Dt(v){let t,r;const s=[v[1],lt];let a={$$slots:{default:[Lt]},$$scope:{ctx:v}};for(let i=0;i<s.length;i+=1)a=F(a,s[i]);return t=new ct({props:a}),{c(){x(t.$$.fragment)},l(i){C(t.$$.fragment,i)},m(i,o){S(t,i,o),r=!0},p(i,[o]){const e=o&2?dt(s,[o&2&&st(i[1]),o&0&&st(lt)]):{};o&5&&(e.$$scope={dirty:o,ctx:i}),t.$set(e)},i(i){r||(j(t.$$.fragment,i),r=!0)},o(i){M(t.$$.fragment,i),r=!1},d(i){A(t,i)}}}const lt={title:"Avatar",desc:"Avatars are used to show a thumbnail representation of an individual or business in the interface.",published:!0,layout:"components"};function It(v,t,r){let s;return nt(v,vt,a=>r(0,s=a)),v.$$set=a=>{r(1,t=F(F({},t),at(a)))},t=at(t),[s,t]}class qt extends ot{constructor(t){super(),rt(this,t,It,Dt,it,{})}}export{qt as component};
