...
bg-primary/<span class="token number">50</span></code>`);var l=a(a(c,!0)),$=s(l),U=a($);n(U,{text:"Border radius"});var i=a(a(l,!0));n(i,{text:"These extended border radius are being used in daisyUI components. The values depend on the theme so you can have a different design decision about border radius of elements based on the active theme. You can use any Tailwind CSS border radius class for these names as well. Like `rounded-r-box` or `rounded-tr-btn`"});var q=a(a(i,!0)),d=a(a(q,!0)),A=s(d);e(A,()=>`<code class="language-json">rounded-box     <span class="token comment">// var(--rounded-box)</span>
...
rounded-badge   <span class="token comment">// var(--rounded-badge)</span>
                <span class="token comment">// for small sized components like badge, etc.</span></code>`);var m=a(a(d,!0)),G=s(m),I=a(G);n(I,{text:"Glass"});var u=a(a(m,!0));n(u,{text:"These glass class to give elements a matte glass effect"});var L=a(a(u,!0)),b=a(a(L,!0)),M=s(b);e(M,()=>'<code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>glass<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>Glass<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span></code>');var g=a(a(b,!0)),Y=s(g),D=a(Y);n(D,{text:"CSS variables"});var k=a(a(g,!0));n(k,{text:"These CSS variables are being used internally. You can customize them in your custom theme in `tailwind.config.js` or you can even customize them with a class name like `[--animation-btn:0]`"});var f=a(a(k,!0)),E=s(f);e(E,()=>`<code class="language-json"><span class="token property">"--rounded-box"</span><span class="token operator">:</span> <span class="token string">"1rem"</span><span class="token punctuation">,</span>          <span class="token comment">// border radius rounded-box utility class, used in card and other large boxes</span>
...
<span class="token property">"--tab-radius"</span><span class="token operator">:</span> <span class="token string">"0.5rem"</span><span class="token punctuation">,</span>         <span class="token comment">// border radius of tabs</span></code>`);var h=a(a(f,!0)),F=s(h),B=a(F);n(B,{text:"Component specific CSS variables"});var v=a(a(h,!0));n(v,{text:"These CSS variables are being used internally for a specific component"});var J=a(a(v,!0)),P=s(J);e(P,()=>`<code class="language-json">tab
...
glass
  ...
  --glass-text-shadow-opacity <span class="token comment">// opacity of text shadow</span></code>`),y(j,o)}})),y(_,t)}export{ea as component};
