...
</dialog>`),h(o,(a,s)=>p(a,s),()=>({to:c()})),d(t,o)},jsx:(t,m)=>{var o=ao(),l=i(o);l.nodeValue=r(`{/* Open the modal using document.getElementById('ID').showModal() method */}
...
</dialog>`),h(o,(a,s)=>p(a,s),()=>({to:c()})),d(t,o)}}});var C=e(e(w,!0));b(C,{title:"Dialog modal, closes when clicked outside",desc:"there is a second form with 'modal-backdrop' class and it covers the screen so we can close the modal when clicked outside",children:(t,m)=>{var o=so(),l=u(o);$("click",l,my_modal_2.showModal(),!1),d(t,o)},$$slots:{default:!0,html:(t,m)=>{var o=no(),l=i(o);l.nodeValue=r(`<!-- Open the modal using ID.showModal() method -->
...
</dialog>`),h(o,(a,s)=>p(a,s),()=>({to:c()})),d(t,o)},jsx:(t,m)=>{var o=mo(),l=i(o);l.nodeValue=r(`{/* Open the modal using document.getElementById('ID').showModal() method */}
...
</dialog>`),h(o,(a,s)=>p(a,s),()=>({to:c()})),d(t,o)}}});var M=e(e(C,!0));b(M,{title:"Dialog modal with a close button at corner",children:(t,m)=>{var o=io(),l=u(o);$("click",l,my_modal_3.showModal(),!1),d(t,o)},$$slots:{default:!0,html:(t,m)=>{var o=co(),l=i(o);l.nodeValue=r(`<!-- You can open the modal using ID.showModal() method -->
...
</dialog>`),h(o,(a,s)=>p(a,s),()=>({to:c()})),d(t,o)},jsx:(t,m)=>{var o=ro(),l=i(o);l.nodeValue=r(`{/* You can open the modal using document.getElementById('ID').showModal() method */}
...
</dialog>`),h(o,(a,s)=>p(a,s),()=>({to:c()})),d(t,o)}}});var P=e(e(M,!0));b(P,{title:"Dialog modal with custom width",desc:"You can use any w-* and max-w-* utility class to customize the width",children:(t,m)=>{var o=ho(),l=u(o);$("click",l,my_modal_4.showModal(),!1),d(t,o)},$$slots:{default:!0,html:(t,m)=>{var o=po(),l=i(o);l.nodeValue=r(`<!-- You can open the modal using ID.showModal() method -->
...
</dialog>`),h(o,(a,s)=>p(a,s),()=>({to:c()})),d(t,o)},jsx:(t,m)=>{var o=bo(),l=i(o);l.nodeValue=r(`{/* You can open the modal using document.getElementById('ID').showModal() method */}
...
</dialog>`),h(o,(a,s)=>p(a,s),()=>({to:c()})),d(t,o)}}});var N=e(e(P,!0));b(N,{title:"Responsive",desc:"Modal goes bottom on mobile screen and goes middle on desktop",children:(t,m)=>{var o=uo(),l=u(o);$("click",l,my_modal_5.showModal(),!1),d(t,o)},$$slots:{default:!0,html:(t,m)=>{var o=$o(),l=i(o);l.nodeValue=r(`<!-- Open the modal using ID.showModal() method -->
...
</dialog>`),h(o,(a,s)=>p(a,s),()=>({to:c()})),d(t,o)},jsx:(t,m)=>{var o=_o(),l=i(o);l.nodeValue=r(`{/* Open the modal using document.getElementById('ID').showModal() method */}
...
</dialog>`),h(o,(a,s)=>p(a,s),()=>({to:c()})),d(t,o)}}});var R=e(e(N,!0)),E=e(e(R,!0));b(E,{title:"Modal using label + hidden checkbox",children:(t,m)=>{var o=vo();d(t,o)},$$slots:{default:!0,html:(t,m)=>{var o=go(),l=i(o);l.nodeValue=r(`<!-- The button to open modal -->
...
</div>`),h(o,(a,s)=>p(a,s),()=>({to:c()})),d(t,o)}}});var I=e(e(E,!0));b(I,{title:"Modal that closes when clicked outside",desc:"Modal works with a hidden checkbox and labels can toggle the checkbox so we can use another label tag with 'modal-backdrop' class that covers the screen so we can close the modal when clicked outside",children:(t,m)=>{var o=fo();d(t,o)},$$slots:{default:!0,html:(t,m)=>{var o=yo(),l=i(o);l.nodeValue=r(`<!-- The button to open modal -->
...
</div>`),h(o,(a,s)=>p(a,s),()=>({to:c()})),d(t,o)}}});var F=e(e(I,!0)),J=e(e(F,!0));b(J,{title:"Modal using anchor link",desc:"Anchor links might not work well on some SPA frameworks so if there are problems, use the first example",children:(t,m)=>{var o=xo();d(t,o)},$$slots:{default:!0,html:(t,m)=>{var o=ko(),l=i(o);l.nodeValue=r(`<!-- The button to open modal -->
...
</div>`),h(o,(a,s)=>p(a,s),()=>({to:c()})),d(t,o)}}}),d(B,g)},$$slots:{default:!0}})),d(H,v)}export{Bo as component};
